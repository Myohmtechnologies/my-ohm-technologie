...
const SimulateurPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="fixed top-0 left-0 right-0 bg-white text-black shadow-sm z-50 px-[10%] py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          <Image
            ...
            className="w-6 h-6"
          />
          <a href="tel:+33123456789" className="text-gray-800 text-lg font-medium hover:text-[#AFC97E] transition-colors">
            01 23 45 67 89
          </a>
        </div>
      </header>
      ...
      {/* Conteneur principal */}
      <div className="flex flex-col lg:flex-row justify-between px-4 md:px-[10%] gap-8 lg:gap-16 mt-24 py-8">
        {/* Section formulaire */}
